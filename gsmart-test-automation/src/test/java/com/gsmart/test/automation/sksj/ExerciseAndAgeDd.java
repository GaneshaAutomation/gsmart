...
public class ExerciseAndAgeDd extends GsmartBaseTest {

	public static final Logger logger = LogManager.getLogger(ExerciseAndAgeDd.class);
	...
	public void ageDDTest() {

		exercisePage.selectAgeDd(2);
